...
public class CustomerService extends ClientService {
	 ...
	 */
	public Coupon PurchaseCoupon(int couponID) throws CouponNotFoundException, CouponNotInStockException, CouponAlreadyPurchasedException, CouponAlreadyExpiredException {
